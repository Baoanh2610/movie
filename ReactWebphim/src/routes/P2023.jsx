    ...
    return (
        <div className='min-h-screen w-full '>
            <div className='content'>
                ...
                <Menu />
                <div className="text-white text-2xl block mr-[65%] mt-[4%] ">PHIM LẺ 2023</div>
                    ...
                    <div id="hanhdong" className="mt-5 mx-auto w-3/4">
                        <table className="table-auto w-full h-full border-separate border-spacing-x-2 border-spacing-y-4 ">
                            <tr>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd1.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd2.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd3.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd4.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd5.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td className=" h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd6.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd7.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd8.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd9.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd10.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td className=" h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd11.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd12.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd13.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd14.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd15.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td className=" h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd16.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd17.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd18.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd19.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd20.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td className=" h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd21.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd22.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd23.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd24.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                                <td className="  h-64 overflow-hidden cursor-pointer">
                                    <div className="w-full h-full">
                                        <img src="../image/hd25.jpg" alt="" className="w-full h-full object-cover hover:scale-110 duration-300" />
                                    </div>
                                </td>
                            </tr>
                        </table>
